...
print('Well thats not exactly cheap is it')
morgage_time = int(input('How many years do you think it would take you to pay off a loan for it?'))
percent_int = float(input('What do you think the annual interest would be? (In decimals please)'))
monthly_int = (percent_int / 12)
total_cost = ((car_price * monthly_int) / (1 - ( 1 + monthly_int) ** -morgage_time))